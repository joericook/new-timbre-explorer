        ...
        return `
            <div class="infoContainer">
                ...
                <p>
                    ...
                    <br><br>
                    For the spectrum dimension, hold down any key that triggers a note. You should hear a continuous note. While still holding down the key, use 
                    ...
                    <br><br>
                    For the brightness dimension, repeat the same process, but this time use the Brightness slider, the second slider from the left. (Hold down a 
                    note key and move the brightness slider to observe its full range of effects. Reset when done). 
                    <br><br>
                    Now for the articulation, we will do something slightly different. To observe its effects you will need to continuously press and release a note 
                    ...
                    <br><br>
                    For the envelope, the process is the same as the articulation. Continuously press and release a key while changing the envelope slider, the last 
